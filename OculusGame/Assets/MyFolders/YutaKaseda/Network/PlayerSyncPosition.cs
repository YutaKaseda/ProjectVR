...
public class PlayerSyncPosition : NetworkBehaviour{
	...
	//Send to Client , value
	[SyncVar]			Vector3		syncPos;
	[SerializeField]	Transform	myTransform;
	[SerializeField]	float		lerpRate;
	[SerializeField]	float		normalLerpRate;
	[SerializeField]	float		fasterLerpRate;
	...
	List<Vector3> syncPosList;

	void Awake(){
		normalLerpRate	=	15;
		fasterLerpRate	=	25;
		useHistoricalLerping	=	false;
		closeEnough		=	0.1f;
