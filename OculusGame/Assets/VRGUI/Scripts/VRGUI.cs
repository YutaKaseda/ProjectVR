...
public abstract class VRGUI : MonoBehaviour 
{
	...
	private void Initialize () 
	{
		...
		if (acceptMouse)
		{
			...
			{
				cursor = Resources.Load("kuro") as Texture;
			}
		}
		...
		{	
			if (acceptMouse)
			{
				...
				/*GUI.DrawTexture(new Rect(cursorPosition.x, cursorPosition.y, cursorSize, cursorSize), 
					cursor);*/
                GUI.DrawTexture(new Rect(cursorPosition.x, cursorPosition.y, cursorSize, cursorSize), cursor);
			}
